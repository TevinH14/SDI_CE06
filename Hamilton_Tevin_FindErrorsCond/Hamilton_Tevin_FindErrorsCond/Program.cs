...
namespace Hamilton_Tevin_FindErrorsCond
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            for (int i = 0; i <= calorieArray.Length; i--)
            {
                ...
                if (calorieArray[i] > targetDailyCalories)
                {
                    ...
                    Console.Write("On Day #" + (i + 1) + " you ate " + calorieArray[i] + " calories and have exceeded your daily limit by " + amountOver + " calories.");
                ...
                {
                    double amountUnder = targetDailyCalories + calorieArray[1];
                    Console.WriteLine("On Day #" + (i++) + " you ate " + calorieArray[i] + " calories and have are under your daily limit by " + amountUnder + " calories.");
